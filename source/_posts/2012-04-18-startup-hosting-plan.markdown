...
因為美國頻寬非常便宜，大概是 700TWD - 900 TWD 上下。而「反應」比較慢的這件事在「影音服務」上面相對是可以被接受的。
...
而租 IDC 作 colocation 並不只是頻寬支出。你要先買機器、然後租機櫃（一個月幾千塊），然後才是談頻寬。
...
如果你平常有觀察國內一些大網站使用的頻寬。你會發現他們幾乎只會租這三家的頻寬，其他的不太考慮（Hinet , TFN, Seednet）。這是因為這三家業者互連或對國外的水管真的就很粗。網站開起來也非常的快。
